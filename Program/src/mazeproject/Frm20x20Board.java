...
public class Frm20x20Board extends javax.swing.JFrame {
    ...
    public Frm20x20Board(String username) throws IOException {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(323, 468));
        ...
        lblBackground.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mazeproject/images/20x20board.PNG"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm20x20Board.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frm20x20Board("jai").setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(Frm20x20Board.class.getName()).log(
