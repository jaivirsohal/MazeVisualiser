...
public class Frm80x80Board extends javax.swing.JFrame {
    ...
    public Frm80x80Board(String username) throws IOException {
        //assign values to attributes
        this.username = username;
        this.fileName = "src/mazeproject/textfiles/scores.txt";
        this.boardSize = "80x80";
    ...
    private void initComponents() {
        ...
        lblBackground.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mazeproject/images/80x80board.PNG"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm80x80Board.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Frm80x80Board("jai").setVisible(true);
                } catch (IOException ex) {
                    Logger.getLogger(Frm80x80Board.class.getName()).log(
